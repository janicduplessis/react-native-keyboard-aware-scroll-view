  ...
  return class
    ...
    constructor(props: KeyboardAwareHOCProps) {
      ...
      const keyboardSpace: number = props.viewIsInsideTabBar
        ...
        : 0
      this.innerViewNodeRef = React.createRef();
    ...
    _updateKeyboardSpace = (frames: Object) => {
      ...
      if (this.props.enableAutomaticScroll) {
        ...
        if (!currentlyFocusedInput || !this.innerViewNodeRef.current) {
          return
        }
        const currentlyFocusedInputHandle = ReactNative.findNodeHandle(currentlyFocusedInput);
        UIManager.viewIsDescendantOf(
          currentlyFocusedInputHandle,
          ReactNative.findNodeHandle(this.innerViewNodeRef.current),
          (isAncestor: boolean) => {
            if (isAncestor) {
    ...
    render() {
      ...
      return (
        <ScrollableComponent
          ...
          {...this.props}
          innerViewRef={this.innerViewNodeRef}
